...
""" comments_to_analyze = comentarios[:50] """
...
# Convertir la lista de comentarios largos en un DataFrame
df_long_comments = pd.DataFrame(long_comments, columns=['Comentarios'])

# Guardar los comentarios largos en un archivo de Excel
df_long_comments.to_excel(f'output/comentarios_largos_{time_stamp}.xlsx', index=False)
...
df_results.to_excel(f'output/resultados_{time_stamp}.xlsx', index=False)
